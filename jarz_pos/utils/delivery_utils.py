...
def get_delivery_account(company):
    ...
    try:
        ...
        frappe.log_error(f"Error getting delivery account: {e!s}", "Delivery Charges")
        raise
...
def add_delivery_charges_to_taxes(invoice_doc, delivery_charges, delivery_description="Delivery Charges"):
    ...
    try:
        ...
        frappe.log_error(f"Error adding delivery charges: {e!s}", "Delivery Charges")
...
def validate_delivery_charges(delivery_charges):
    ...
    try:
        ...
        return False, f"Invalid delivery charges format: {e!s}"
...
def get_delivery_tax_summary(invoice_doc):
    ...
    try:
        ...
        frappe.log_error(f"Error getting delivery tax summary: {e!s}", "Delivery Charges")
        return {

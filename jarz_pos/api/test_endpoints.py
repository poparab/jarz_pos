...
def test_bundle_processing():
    ...
    """
    try:
        from jarz_pos.services.bundle_processing import process_bundle_for_invoice, validate_bundle_configuration_by_item
        ...
        frappe.log_error(f"Bundle test error: {str(e)}", "Bundle Test")
        return {
            'success': False,
            'error': str(e)
        }
...
def test_delivery_charges():
    ...
    try:
        ...
        frappe.log_error(f"Delivery test error: {str(e)}", "Delivery Test")
        return {
            'success': False,
            'error': str(e)
        }
...
def test_invoice_creation_with_bundle():
    ...
    try:
        ...
        frappe.log_error(f"Invoice creation test error: {str(e)}", "Invoice Test")
        return {
            'success': False,
            'error': str(e)
        }

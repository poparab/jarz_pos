...
class TestNotificationAPI(unittest.TestCase):
	...
	def test_get_recent_invoices_minutes_parameter(self):
		...
		# 60 minutes should return same or more invoices than 5 minutes
		self.assertGreaterEqual(
			len(result_60["invoices"]),
			len(result_5["invoices"]),
			"Longer time window should return same or more invoices",
		)
